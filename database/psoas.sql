...
-- Dumping data for table psoas.announcements: ~3 rows (approximately)
/*!40000 ALTER TABLE `announcements` DISABLE KEYS */;
INSERT INTO `announcements` (`id`, `title`, `message`, `announcer`, `publish`, `created`, `updated`) VALUES
	(1, 'test title', 'test message', 1, '2016-03-20 17:33:28', '2016-03-20 17:33:30', '2016-03-20 17:33:32'),
	(2, 'test title', 'test message', 1, NULL, NULL, NULL),
	(3, 'test title', 'test message', 1, '2016-03-21 01:18:31', NULL, NULL);
...
-- Dumping data for table psoas.categories: ~1 rows (approximately)
...
INSERT INTO `contests` (`id`, `title`, `description`, `creator`, `status`, `created`, `updated`) VALUES
	(1, 'test', 'test', 1, 1, '2016-03-19 04:53:52', '2016-03-19 04:53:52'),
	(2, 'testing title', 'testing description', 1, 1, NULL, NULL);
/*!40000 ALTER TABLE `contests` ENABLE KEYS */;


-- Dumping structure for table psoas.group_announcements
CREATE TABLE IF NOT EXISTS `group_announcements` (
  `announcement` int(50) unsigned NOT NULL,
  `group_id` int(50) unsigned NOT NULL,
  PRIMARY KEY (`announcement`,`group_id`),
  KEY `group_id` (`group_id`),
  CONSTRAINT `group_announcements_ibfk_1` FOREIGN KEY (`announcement`) REFERENCES `announcements` (`id`),
  CONSTRAINT `group_announcements_ibfk_2` FOREIGN KEY (`group_id`) REFERENCES `groups` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Dumping data for table psoas.group_announcements: ~0 rows (approximately)
/*!40000 ALTER TABLE `group_announcements` DISABLE KEYS */;
/*!40000 ALTER TABLE `group_announcements` ENABLE KEYS */;
...
-- Dumping data for table psoas.settings: ~3 rows (approximately)
...
INSERT INTO `users` (`id`, `name`, `email`, `pass_hash`, `coins`, `is_admin`, `is_active`, `last_login`, `created`, `updated`) VALUES
	(1, 'furqan', 'ahmedfurqan88@gmail.com', 'df4358b3b8209d8123ac6384d02ef8d0', 5, 0, 1, NULL, '2016-03-16 22:26:02', '2016-03-16 22:26:02'),
...
INSERT INTO `user_settings` (`id`, `user_id`, `setting`, `status`, `created`, `updated`) VALUES
	(1, 1, 1, 0, '2016-03-17 09:02:30', '2016-03-17 09:02:30'),
...
CREATE TABLE IF NOT EXISTS `votes` (
  ...
  CONSTRAINT `votes_ibfk_2` FOREIGN KEY (`contest`) REFERENCES `contests` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=latin1;

-- Dumping data for table psoas.votes: ~1 rows (approximately)
/*!40000 ALTER TABLE `votes` DISABLE KEYS */;
INSERT INTO `votes` (`id`, `user_id`, `contest`, `rating`, `created`, `updated`) VALUES
	(2, 1, 1, 1, NULL, NULL);
